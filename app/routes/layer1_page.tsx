...
export default function Home() {
    const { upperSubjectName, upperSubjectCode, articles, activeSubjects, chartData } = useLoaderData();
                                    ...
                                    {subjects.map((subject: string, index: number) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <Link
                                                    to={`/layer2?upperSubjectCode=${subjects_code[index]}&upperSubjectName=${subject}`}
